...
const openai = new OpenAI({
  ...
  defaultHeaders: {
    "HTTP-Referer": "https://nik-gpt.vercel.app", // optional
    "X-Title": "Nik Gpt", // optional
  },
});
  ...
  const predefinedReplies = [
    {
      ...
      reply: "I'm an AI chatbot created by Nikhil.",
    },
    {
      keywords: ["your name", "what's your name"],
      reply: "My name is NikhilBot, created by Nikhil.",
    },
    {
      keywords: ["who made you", "who created you", "who build you"],
      reply: "I was developed by Nikhil using OpenAI's models.",
    },
    {
